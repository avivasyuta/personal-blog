...
const workPlaces: CompanyGroup[] = [
  ...
  },
  {
    ...
    companyDescription: 'Digital bank with 15M+ customers, part of the MTS telecommunications group.',
    ...
    <section className="w-full py-20 md:py-28 2xl:py-36 border-t border-border">
      <div className="mx-auto flex w-full max-w-7xl flex-col gap-8 px-4 md:gap-16 md:px-8">
        ...
        <div className="mx-auto w-full max-w-3xl">
          {workPlaces.map((group, i) => (
            <CompanyTimelineBlock
              key={group.company}
              company={group.company}
              companyDescription={group.companyDescription}
              companyLogoPath={group.companyLogoPath}
